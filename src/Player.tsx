...
export function Player() {
  ...
  const countableTrains = useMemo(() => countableVehicleTrains(visibleSnapshot, stations, { station: selectedStation }), [visibleSnapshot, stations, selectedStation])
